...
import { mockUser, mockProject, mockAsset } from '../setup';
...
beforeEach(() => {
    ...
    mockServices.UserService.findByFirebaseUid.mockResolvedValue(mockUser);
    mockServices.UserService.deductCredits.mockResolvedValue({ ...mockUser, credits: 95 });
});
...
async function generateSpriteHandler(req: any, res: any, services: any) {
    try {
        // Check authorization
...
async function getUserProfileHandler(req: any, res: any, services: any) {
    const user = req.user;
...
async function createProjectHandler(req: any, res: any, services: any) {
    const project = {
        id: 'new_project_id',
        user_id: req.user.id,
        ...req.body,
...
async function deleteProjectHandler(req: any, res: any, services: any) {
    return res.status(200).json({
        success: true,
...
async function generateAnimationHandler(req: any, res: any, services: any) {
